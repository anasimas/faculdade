...
public class View {
	...
	public static void msgCadastroDeProduto(Loja loja, Produto produto, String codigo, int quantidade) { //serve para adicionar um novo produto do zero ou quando o código não é encontrado na busca do estoque
		...
		Produto novoProduto = produto.novoProduto(JOptionPane.showInputDialog("Informe a descrição do produto: "), codigo, quantidade, (Double.parseDouble(JOptionPane.showInputDialog("Informe o valor do produto: "))));
	...
	public static void msgEntradaDeEstoque(Loja loja) {
		loja.entradaDeEstoque(
				JOptionPane.showInputDialog("Informe o código do produto que deseja dar entrada no estoque: "),
				Integer.parseInt(JOptionPane.showInputDialog("Informe a quantidade a ser adicionada: ")));
	}
